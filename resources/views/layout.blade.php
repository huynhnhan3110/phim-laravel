                     ...
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              @foreach($genre as $key => $ger)
                              <li><a title="{{$ger->title}}" href="{{route('genre',$ger->slug)}}">{{$ger->title}}</a></li>
                             @endforeach
                           </ul>
                        </li>
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              ...
                              <li><a title="{{$cout->title}}" href="{{route('country',$cout->slug)}}">{{$cout->title}}</a></li>
                               @endforeach
                           </ul>
                        </li>
                        @foreach($category as $key => $cate)
                           <li class="current-menu-item"><a title="{{$cate->title}}" href="{{route('category',$cate->slug)}}">{{$cate->title}}</a></li>
                        @endforeach
                     </ul>
                  </div>
